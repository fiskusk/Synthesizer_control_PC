...
#region Registers controls group
        ...
        private void WriteRegisterButton_Click(object sender, EventArgs e)
        {
            ...
            string regNumber = string.Join("", senderName.ToCharArray().Where(Char.IsDigit));
            string registerTextBoxName = "Reg" + regNumber + "TextBox";
            controller.SetAndSendRegChangesIntoPlo((((Button)(sender)).Name), Controls.Find(registerTextBoxName, true).FirstOrDefault().Text);
        }
...
#region Vco Calibration
        ...
        private void FreqStepTextBox_LostFocus(object sender, EventArgs e)
        {
            controller.vcoCalibration.SetFrequencyStep(FreqStepTextBox.Text);
        }
